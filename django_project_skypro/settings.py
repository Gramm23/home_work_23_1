"""
Django settings for django_project_skypro project.
...
SECRET_KEY = 'django-insecure-bg7@1*box%_sf$#y(g$d8nuw66uoyj(6&8+3_33kadzwhocv3w'
...
ROOT_URLCONF = 'django_project_skypro.urls'
...
WSGI_APPLICATION = 'django_project_skypro.wsgi.application'
